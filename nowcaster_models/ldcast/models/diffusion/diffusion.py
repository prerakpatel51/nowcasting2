# Copied from LDCast paper: ldcast/models/diffusion/diffusion.py. No modifications.
...
class LatentDiffusion(pl.LightningModule):
    ...
    def on_validation_epoch_end(self):
        # Log train_loss here so all metrics land in one CSV row with val metrics
        if hasattr(self, "_train_losses") and self._train_losses:
